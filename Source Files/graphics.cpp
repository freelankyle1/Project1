...
Graphics::Graphics(HWND hWnd)
{
	...
	ASSERT(hr, "failed to create sampler state");

	hr = CreateDDSTextureFromFile(m_Device.Get(), L"Source Files/Textures/woodtexture.dds", nullptr, m_Texture.GetAddressOf());
	ASSERT(hr, "failed to create texture");
